          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:gap-8 mb-16">
            ...
            <div className="grid grid-cols-2 gap-8 md:col-span-5 md:col-start-7 md:grid-cols-2">
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/classifieds" className="font-sans text-sm text-zinc-600 hover:text-zinc-900 transition-colors">Classifieds</Link></li>
                <li><Link to="/classifieds/post" className="font-sans text-sm text-zinc-600 hover:text-zinc-900 transition-colors">Post a Classified</Link></li>
